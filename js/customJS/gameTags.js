$(function(){
	...
	$("#gameField").on("mouseenter", "div.emptyTag", function() {
	...
	$("#gameField").on("click", "div.emptyTag", function() {
	...
	$("#gameField").on("click", "#tagButton", function() {
		...
		var send = "content=" + content + "&&id=" + form.attr("belong_id") + "&&type=game";
		$.ajax({
			type: 'POST',
			url: 'modifyTag.php',
			data: send,
	...
	$("#gameField").on("click", "div.tag", function() {
		$(this).css("border-width", "5px");
	});

	$("#gameField").on("mouseenter", "div.tag", function() {
	...
	/*****like function*****/
	$("#gameField").on("mouseenter", "div.tagLikes i", function() {
	...
	$("#gameField").on("click", "div.tagLikes i", function() {
		//console.log("%o", (this));
		...
		var send = "likes=" + likes + "&&id=" + id + "&&type=game";
		$.ajax({
			type: 'POST',
			url: 'modifyTag.php',
			data: send,
	...
	/*****delete function*****/
	$("#gameField").on("mouseenter", "div.tag i", function() {
		$(this).css("color", "white");
	}).on("mouseleave", "div.tag i", function() {
		$(this).css("color", "black");
	});

	$("#gameField").on("click", "div.tag i.fa-times", function() {
